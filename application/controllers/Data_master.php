...
class Data_master extends CI_Controller
{
    ...
    public function select_class() {
        ...
        $data['kelas']=$this->M_data_master->pilih_kelas();
    ...
    public function delete_siswa($id_siswa){
        ...
        // $data = $this->M_data_master->get_siswa($id_siswa)->result_array();

        $delete_siswa = $this->M_data_master->delete_siswa($id_siswa);
