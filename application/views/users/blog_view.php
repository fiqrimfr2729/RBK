...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url().'assets/images/dd.png'?>"/>
                            ...
                            ?>
                                ...
                                <article class="post">
                                    ...
                                    <div class="entry-media">
                                        <a href="<?php echo $row->tulisan_slug;?>" target="_blank" class="post-thumbnail hover-zoom"><img src="<?php echo base_url().'assets/images/'.$row->tulisan_gambar;?>" alt=""></a>
                                    ...
                                    <div class="entry-header">
                                        <h2 class="entry-title"><a href="<?php echo $row->tulisan_slug;?>" target="_blank"><?php echo $row->tulisan_judul;?></a></h2>
                                    </div>
