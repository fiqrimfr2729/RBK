            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  ...
                  <form class="user" action="<?php echo base_url('Login/cari_email') ?>" method="GET">
                    <!-- Notifikasi -->
                    
                  <!-- /Notifikasi -->
                  <div class="form-group">
                    <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Masukkan alamat email..." name="cari">
                  </div>
                  ...
                  <?php if (count($result) > 0) {
                    echo "<a href=".site_url('Login/view_email/'.$result[0]->id_users)."><font size='4'>".$result[0]->email_admin."</font></a>";
                  } else {
                    echo "<center><font color='red'><h3>Email Tidak ditemukan</h3></font></center>";
                    } ?>
                  </center>
                </form>
                <hr>
