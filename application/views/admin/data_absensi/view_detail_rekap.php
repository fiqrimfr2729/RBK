<!-- Page Heading -->
<!-- <h1 class="h3 mb-2 text-gray-800">Detail Rekap : <?= $detail_siswa['nama_siswa']; ?></h1> -->

<!-- DataTales Example -->
<div class="card shadow mb-4">
  <div class="card-header py-3">
      <h6 class="float-left text-primary font-weight-bold" style="margin-top: 10px">Detail Rekap Absensi <?= $detail_siswa['nama_siswa']?></h6>
  ...
  <div class="card-body">
    <!-- <div class="table-responsive"> -->
      ...
      <div class="col-md-12">
           ...
           <!-- <h3 class="mb-5">Detail Data Sidang Tugas Akhir <?=$detail_siswa['nama_siswa'];?> </h3> -->
           <div class="block-content">
            <div class="row mt-4">
              <div class="col-md-4">
                ...
                <h5 class="text-dark mb-0 font-16 font-weight-medium" style="font-size: 14px;"><?=$detail_siswa['nama_siswa']?></h5>
                <br>
                <strong><p>Jenis Kelamin</p></strong>
                <h5 class="text-dark mb-0 font-16 font-weight-medium" style="font-size: 14px;"><?php if($detail_siswa['jk']=='1'){echo 'Laki-laki';}else{echo 'Perempuan';} ?></h5>
                <br>
             ...
             <div class="col-md-4">
               ...
               <h5 class="text-dark font-16 font-weight-medium" style="font-size: 16px;"><span class="badge badge-pill badge-primary"><?=$total_izin;?></span></h5>
