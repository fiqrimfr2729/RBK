      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data_kelas ?></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-home fa-2x text-gray-300"></i>
          </div>
  ...
  <div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-info shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Data Konseling</div>
            <div class="row no-gutters align-items-center">
              <div class="col-auto">
                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $data_konseling ?></div>
              </div>
            </div>
          </div>
          <div class="col-auto">
...
<div class="row">
  ...
  <div class="col-lg-12 col-xs-12">
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        <form action="<?php echo base_url('guru/dashboard') ?>" method="post">
